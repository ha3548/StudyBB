...
<script>
   ...
   $(function() {
      ...
      //해당 스터디의 지역과 일치하는 지역이 선택되어있도록(selected="selected")
      $("#area option").each(function() {
          if($(this).text() == '${requestScope.study.study_area}')
     ...
     //login 정보 연결
      ...
      $("form").submit(function() {
         ...
         var s_no = '${requestScope.study.study_no}';
         formData.append("study_no", s_no);
         $.ajax({
            url : '${contextPath}/studyedit',
            method : 'post',
...
<body>
<c:set var="s" value="${requestScope.study}"/>
<section class="page-section">
   <div class="container shadow p-3">
      <div class="row">
         <div class="col-lg-12 text-center">
            <i class="fas fa-edit fa-5x"></i>
            <h2 class="section-heading text-uppercase fontbold mt-3">
               <span class="y">스터디 수정하기</span></h2>
            <h3 class="section-subheading text-muted">
            <span class="fontthin">${s.study_no}번 글</span>
            </h3>   
         </div>
      </div>
                     ...
                     <div class="form-group">
                        ...
                        <div>
                           <img id="study_image" class="img-fluid"
                              src="images/study/${s.study_no}.jpg" alt="">
                        </div>
                     </div>
                     <div class="form-group">
                        <span class="fontbold">자기 소개</span>
                        <textarea class="form-control fontthin"
                           name="study_leader_intro" rows="6"
                           placeholder="스터디원에게 자신을 소개해보세요." required="required"
                           data-validation-required-message="">${s.study_leader_intro}</textarea>
                        <p class="help-block text-danger"></p>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <textarea class="form-control fontthin" name="study_content" rows="3"
                           placeholder="상세 일정, 진행 방식, 스터디 규칙 등을 자세히 설명해주세요. ex) 주 2회 (월, 수) 오후  6시~8시" required="required"
                           data-validation-required-message="">${s.study_content}</textarea>
                        <p class="help-block text-danger"></p>
                     </div>
                     <div class="form-group">
                        <span class="fontbold">지역</span><br> 
                        <select name="study_area" class="fontthin p-2" id="area">
                     ...
                     <div class="form-group">
                        ...
                        <input style="display: inline-block;"
                           ...
                           value="${s.study_week}" placeholder="" required="required" min="1" max="99"
                     ...
                     <div class="form-group">
                        ...
                        <input style="display: inline-block;"
                           ...
                           name="study_price" type="number" step="1000" min="0" value="${s.study_price}"
                           required="required" data-validation-required-message=""><span>원</span>
                        <p class="help-block text-danger"></p>
                     </div>
                     <div class="form-group">
                        <span class="fontbold">태그</span> 
                        <input class="form-control fontthin" value="${s.study_tag}"
